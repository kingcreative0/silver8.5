     ...
     await channel.delete();
        ...
        await backups[message.author.id][code].roles.forEach(async function(role) {
          message.guild.roles.create({ data: { 
           ...
           }, reason: "Luisa Plus+ Backup Sistemi" })
        });
...
`)
          .setColor("RANDOM")
        // .addField("• Sponsor:", `• Bize sponsor olan **..**'e teşekkür ederiz! [Sunucu]() • [Site]() • (Dikkat Luisa Plusun destek sunucusu burası değildir, lütfen gidip yetkililerden  Luisa Plus+hakkında yardım istemeyin! [Destek Sunucumuz](https://discord.gg/paypal))`)
